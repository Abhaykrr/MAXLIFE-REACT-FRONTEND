  ...
  return (
    <div>
      ...
      <div className="col-md-10 ">
        ...
        <div className="col-xl-3 col-lg-6" onClick={() => {
              navigate('/admin/dashboard/messages'); // Navigate to messages
            }}>
              <div className="card l-bg-green-dark">
                <div className="card-statistic-3 p-4">
                  <div className="card-icon card-icon-large"><i className="fas fa-ticket-alt"></i></div>
        ...
        <div className="col-xl-3 col-lg-6"onClick={()=>{
           navigate('/admin/dashboard/addemploye')
         }}>
          <div class="card l-bg-orange-dark">
                  <div className="card-statistic-3 p-4">
                      <div className="card-icon card-icon-large"><i className="fas fa-ticket-alt"></i></div>
        ...
        <div className="col-xl-3 col-lg-6" onClick={()=>{
           navigate('/admin/dashboard/allaccounts')
        }}>
            <div className="card l-bg-green-dark">
                <div className="card-statistic-3 p-4">
                    <div className="card-icon card-icon-large"><i className="fas fa-ticket-alt"></i></div>
                    <div className="mb-4">
                        <h5 className="card-title mb-0">All Accounts</h5>
                    </div>
                    <div className="row align-items-center mb-2 d-flex">
                        <div className="col-8">
                            <h5 className="d-flex align-items-center mb-0">
        ...
        <div className="col-xl-3 col-lg-6" onClick={()=>{
           navigate('/admin/dashboard/allclaims')
        }}>
        ...
        <div className="col-xl-3 col-lg-6" onClick={()=>{
           navigate('/admin/dashboard/bgv')
        }}>
            <div className="card l-bg-cherry">
                <div className="card-statistic-3 p-4">
                    <div className="card-icon card-icon-large"><i className="fas fa-ticket-alt"></i></div>
                    <div className="mb-4">
                        <h5 className="card-title mb-0">Background</h5>
                    </div>
                    <div className="row align-items-center mb-2 d-flex">
                        <div className="col-8">
                            <h5 className="d-flex align-items-center mb-0">
